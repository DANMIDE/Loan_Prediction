...
st.markdown("<h1 style = 'color: #F9F5F6; text-align: center; font-size: 60px; font-family: Georgia'>LOAN PREDICTOR APP</h1>", unsafe_allow_html = True)
st.markdown("<h4 style = 'margin: -30px; color: #E72929; text-align: center; font-family: italic'>BUILT BY MIDE </h4>", unsafe_allow_html = True)
...
if st.button('Check Your Loan Approval Status'):
    if predict[0] == 0:
        ...
        st.image('pngwing.com (16).png', width = 300)
    else:
        ...
        st.image('pngwing.com (17).png', width = 300)
        st.balloons()